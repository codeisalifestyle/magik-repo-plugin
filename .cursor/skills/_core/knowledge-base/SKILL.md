...
name: knowledge-base
description: >-
  Create, update, and prune knowledge base entries under knowledge/<domain>/
  using the five schemas (concept, decision, policy, specification, fieldnote).
  Use when capturing project ground truth, recording decisions, defining
  policies, writing specs, or noting a lesson.
---
