...
description: >-
  Read, propose, and update the project's domain registry at
  knowledge/_meta/domains.md. Use when the user asks to add / rename / split /
  deprecate a domain, when content accumulates outside the registry, or before
  any structural change to knowledge/<domain>/ or .cursor/skills/<domain>/.
---
